...
public class StorageHelper {
    ...
    // ==========================================
    // 2. SESSION MANAGER (Load & Save Tab)
    // ==========================================

    public void saveSessions() {
        try {
            StringBuilder sb = new StringBuilder();
            // Akses variabel di MainActivity harus pake activity.variabel
    ...
    public void loadSessions() {
        ...
        // Panggil method UI di MainActivity buat update tampilan
